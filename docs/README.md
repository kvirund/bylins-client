...
Единая точка входа в документацию проекта. Установка, возможности и сборка —
в [../README.md](../README.md); общий обзор стека и модулей — в
[../ARCHITECTURE.md](../ARCHITECTURE.md); что не сделано — [../ROADMAP.md](../ROADMAP.md);
инструкции для агентов — [../CLAUDE.md](../CLAUDE.md).
...
| [TABS_DESIGN.md](TABS_DESIGN.md) | **Вкладки**: фильтры, COPY/MOVE, хранение. **С разделом «Подводные камни»** (потоки, нумерация строк, цвет в фильтрах) |
| [EXAMPLES.md](EXAMPLES.md) | Примеры триггеров и алиасов, в том числе из кода |
