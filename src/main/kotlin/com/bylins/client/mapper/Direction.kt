...
enum class Direction(
    ...
    /**
     * Короткая русская команда движения: с, ю, в, з, св, сз, юв, юз, вв, вн.
     * Ею и ходит клиент — короче печатать в лог и привычнее в выводе.
     *
     * В [commands] порядок фиксирован: английское полное, английское краткое,
     * русское полное, русское краткое; проверяется в тестах.
     */
    val russianShort: String get() = commands.last()
